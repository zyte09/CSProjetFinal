...
Partial Class LoginForm
    ...
    Private Sub InitializeComponent()
        ...
        ' cbtn_connect
        ' 
        cbtn_connect.BackColor = Color.FromArgb(CByte(145), CByte(141), CByte(141))
        cbtn_connect.BackgroundColor = Color.FromArgb(CByte(145), CByte(141), CByte(141))
        ...
        cbtn_connect.FlatAppearance.MouseDownBackColor = Color.FromArgb(CByte(62), CByte(60), CByte(60))
        cbtn_connect.FlatAppearance.MouseOverBackColor = Color.FromArgb(CByte(125), CByte(120), CByte(120))
        cbtn_connect.FlatStyle = FlatStyle.Flat
        cbtn_connect.Font = New Font("Segoe UI", 16.2F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        cbtn_connect.ForeColor = Color.White
        cbtn_connect.Location = New Point(399, 541)
        cbtn_connect.Name = "cbtn_connect"
        cbtn_connect.Size = New Size(365, 50)
        cbtn_connect.TabIndex = 8
        cbtn_connect.Text = "Connection"
        cbtn_connect.TextColor = Color.White
        cbtn_connect.UseVisualStyleBackColor = False
        ' 
        ' cbtn_login
        ' 
        cbtn_login.BackColor = Color.FromArgb(CByte(145), CByte(141), CByte(141))
        cbtn_login.BackgroundColor = Color.FromArgb(CByte(145), CByte(141), CByte(141))
        ...
        cbtn_login.Location = New Point(399, 470)
        ...
        Label1.Font = New Font("Lato", 14.0F)
        Label1.ForeColor = SystemColors.ButtonFace
        Label1.Location = New Point(399, 272)
        Label1.Name = "Label1"
        ...
        txt_Welcome.Font = New Font("Lato", 28.1999989F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        txt_Welcome.ForeColor = SystemColors.Control
        txt_Welcome.Location = New Point(385, 181)
        txt_Welcome.Name = "txt_Welcome"
        txt_Welcome.Size = New Size(241, 56)
        ...
        Label2.Font = New Font("Lato", 14.0F)
        Label2.ForeColor = SystemColors.ButtonFace
        Label2.Location = New Point(399, 363)
        Label2.Name = "Label2"
        ...
        ' txtbox_password
        ' 
        txtbox_password.BackColor = Color.FromArgb(CByte(25), CByte(24), CByte(24))
        ...
        txtbox_password.Location = New Point(399, 404)
        ...
        ' txtbox_username
        ' 
        txtbox_username.BackColor = Color.FromArgb(CByte(25), CByte(24), CByte(24))
        ...
        txtbox_username.Location = New Point(399, 319)
